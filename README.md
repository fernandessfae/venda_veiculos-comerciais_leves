...
<div style="text-align: justify;">Olhando o gráfico vemos que grande partes das vendas acima do valor de venda máximo estão entre os anos de 2010, 2011, 2012 e 2013, sendo os meses de dezembro, dezembro, agosto e dezembro as maiores vendas mensais de cada ano, respectivamente. A partir dai já podem surgir uma pergunta  bastante pertinente sobre esses outliers:</div><br/>
...
<div style="text-align: justify;">Como podemos observar, a série temporal está "normalizada", mas não está estacionária. Fazendo com que seja necessário fazer uma diferenciação nos dados.</div>
